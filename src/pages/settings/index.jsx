...
const Index = () => {
  ...
  return (
    ...
    >
      <Settings open={open} setOpen={setOpen} user={user} getUser={getUser} />
      <Card
        style={{
          width: "100%",
        }}
          ...
          <Col span={18}>
            <Row gutter={[16, 16]}>
              <Col span={12}>
                ...
                <br />
                <Text style={{ fontSize: "28px" }}>{user?.first_name}</Text>
              </Col>
              <Col span={12}>
                <Text style={{ fontSize: "16px", fontWeight: "small" }}>
                  Email
              ...
              <Col span={12}>
                ...
                <br />
                <Text style={{ fontSize: "28px" }}>{user?.last_name}</Text>
              </Col>
              <Col span={12}>
                <Text style={{ fontSize: "16px", fontWeight: "small" }}>
                  Phone number
                ...
                <br />
                <Text style={{ fontSize: "28px" }}>{user?.phone_number}</Text>
              </Col>
            </Row>
          </Col>
        </Row>
